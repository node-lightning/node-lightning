...
describe('initiator', () => {
  ...
  test('transport-initiator act2 short read test', async () => {
    ...
    expect(sut.initiatorAct2(input)).rejects.toEqual(new Error('ACT2_READ_FAILED'));
  });
  ...
  test('transport-initiator act2 bad version test', async () => {
    ...
    expect(sut.initiatorAct2(input)).rejects.toEqual(new Error('ACT2_BAD_VERSION'));
  });
  ...
  test('transport-initiator act2 bad key serialization test', async () => {
    ...
    expect(sut.initiatorAct2(input)).rejects.toEqual(new Error('Unknown point format'));
  });
