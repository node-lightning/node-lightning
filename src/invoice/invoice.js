...
class Invoice {
  static deserialize(paymentInvoice) {
    let { prefix, words } = bech32.decode(paymentInvoice, 1037);
    ...
    let signature = reader.readBits(520, true);
