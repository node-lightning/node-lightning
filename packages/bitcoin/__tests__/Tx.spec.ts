...
6816c216d204b2b696421d5e685d399c5d803be01c00",
                    ...
                    vin: [
                        {
                            ...
                            scriptSig: {
                                ...
                                hex: "1600140c3928c9f33355eacd8b4b5fabc542543f399702",
                            },
                            txinwitness: [
                    ...
                    vout: [
                        {
                            ...
                            scriptPubKey: {
                                ...
                                hex: "0014bbf06c4ac80e0bc66f675fc680444ccc8b155207",
                            },
                        },
                        {
                            value: 69.35741188,
                            scriptPubKey: {
                                ...
                                hex: "001466b90139c95161d9563ddb6ffc0d3df8247bf5f2",
                            },
                        },
                    ],
                },
        ...
        for (const [title, input, expected] of tests) {
            it(title, () => {
                ...
                for (let i = 0; i < result.inputs.length; i++) {
                    ...
                    expect(vin.scriptSig.toString()).to.equal(expected.vin[i].scriptSig.hex);
    ...
    describe(".toHex()", () => {
        it("pretty", () => {
            const sut = Tx.fromHex(""); // prettier-ignore
...
00000000`);
    ...
    describe(".isCoinbase", () => {
        it("returns true", () => {
            const sut = Tx.fromHex(
                "",
            );
            expect(sut.isCoinbase).to.equal(true);
        });

        it("returns true", () => {
            const sut = Tx.fromHex(
                "",
            );
            expect(sut.isCoinbase).to.equal(true);
        });
...
16b74bc2b2e88ac00000000",
            ...
            expect(sut.isCoinbase).to.equal(false);
        });
    });
});
