...
describe("TxBuilder", () => {
     ...
     */
    function spend_p2pkh_to_p2pkh(): TxBuilder {
     ...
     */
    function spend_p2pk_to_p2pk(): TxBuilder {
     ...
     *      txid:
     */
    function spend_p2sh_p2pkh_to_p2sh(): TxBuilder {
        const sut = new TxBuilder();
        sut.version = 2;
        // p2sh-p2pkh
        sut.addInput(
    ...
    function spend_p2sh_to_p2sh(): TxBuilder {
        const sut = new TxBuilder();
        sut.version = 2;
        sut.addInput(
            OutPoint.fromString(
