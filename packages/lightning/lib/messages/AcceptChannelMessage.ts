...
export class AcceptChannelMessage implements IWireMessage {
    ...
    public static deserialize(buf: Buffer): AcceptChannelMessage {
        ...
        instance.dustLimitValue = Value.fromSats(reader.readUInt64BE());
        instance.maxHtlcValueInFlightValue = Value.fromMilliSats(reader.readUInt64BE());
        instance.channelReserveValue = Value.fromSats(reader.readUInt64BE());
        instance.htlcMinimumValue = Value.fromMilliSats(reader.readUInt64BE());
     ...
     * HTLCs.
     */
    public maxHtlcValueInFlightValue: Value;
    ...
    public serialize(): Buffer {
        ...
        writer.writeUInt64BE(this.dustLimitValue.sats);
        writer.writeUInt64BE(this.maxHtlcValueInFlightValue.msats);
        writer.writeUInt64BE(this.channelReserveValue.sats);
        writer.writeUInt64BE(this.htlcMinimumValue.msats);
